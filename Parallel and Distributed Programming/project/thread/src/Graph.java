...
public class Graph {
    ...
    public static Graph generateRandomGraph(int nodesNumber, int edgesNumber){
        ...
        while(graph.getEdgeCount() < edgesNumber){
            int startNode = random.nextInt(nodesNumber);
            int endNode = random.nextInt(nodesNumber);

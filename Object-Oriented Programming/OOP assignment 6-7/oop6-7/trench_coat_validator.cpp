...
void TrenchCoatValidator::validate(TrenchCoat &t) {
    ...
    && t.get_trench_size() != "S" && t.get_trench_size() != "M" && t.get_trench_size() != "L"
    && t.get_trench_size() != "XL" && t.get_trench_size() != "XXL" && t.get_trench_size() != "XXXL"
    && t.get_trench_size() != "XXXXL" && t.get_trench_size() != "XXXXXL") {
